...
class PosterDashboardScreen extends ConsumerStatefulWidget {
  const PosterDashboardScreen({super.key});

  @override
  ConsumerState<PosterDashboardScreen> createState() => _PosterDashboardScreenState();
}

class _PosterDashboardScreenState extends ConsumerState<PosterDashboardScreen> {
  @override
