...
class EarnerDashboardScreen extends ConsumerStatefulWidget {
  const EarnerDashboardScreen({super.key});

  @override
  ConsumerState<EarnerDashboardScreen> createState() => _EarnerDashboardScreenState();
}

class _EarnerDashboardScreenState extends ConsumerState<EarnerDashboardScreen> {
  @override
